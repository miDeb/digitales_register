...
class RSACipher18Implementation {
    ...
    private void createKeys(Context context) throws Exception {
        ...
        try {
            ...
            if(Build.VERSION.SDK_INT <= Build.VERSION_CODES.P && !(e instanceof StrongBoxUnavailableException)) throw e;
            StrongBoxUnavailableException se = (StrongBoxUnavailableException) e;
